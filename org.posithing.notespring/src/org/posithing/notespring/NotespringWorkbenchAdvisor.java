...
public class NotespringWorkbenchAdvisor extends WorkbenchAdvisor
{
	public NotespringWorkbenchAdvisor()
	{
		super();
	}
	...
	{
		return new NotespringWorkbenchWindowAdvisor(configurer);
	}

	@Override
	public String getInitialWindowPerspectiveId()
	{
		return NotespringPerspective.ID;
	}
	 ...
	 */
	private void declareWorkbenchImage(final Bundle ideBundle, final String symbolicName, final String path,
